...
btnClear.addEventListener("click", function(event){
    ...
    txtNombre.value="";
    txtNumber.value="";
    //Limpiar el localStorage (removeItem para ir por un elemento en concreto / .clear elmina todo el contenido)
    localStorage.clear();
    //Limpiar la tabla
...
// Evento blur es cuando un campo pierde el foco osea se sale del campo
